        ...
        <html>
          <body style="font-family: Montserrat, Arial; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background-color: #F5F0EB; padding: 30px; border-radius: 8px; text-align: center;">
              <h2 style="color: #4B1A3E; margin-top: 0;">Votre nouveau code de connexion</h2>
              ...
              <p style="color: #999; font-size: 12px; margin-top: 20px;">Ce code remplace votre ancien PIN. Gardez-le précieusement, il vous servira à chaque connexion.</p>
            </div>
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { error: updateError } = await supabase
      .from('profiles')
      .update({ pin: newPin, pin_attempts: 0 })
      .eq('email', email);
